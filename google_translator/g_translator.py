...
lab_txt = Label(root, text="Translator", font=("Times New Roman", 40, "bold"),bg="red")
lab_txt.place(x=100, y=40, height=50, width=300)

lab_src_txt = Label(root, text="Source Text", font=("Times New Roman", 20, "bold"), fg="black", bg="red")
lab_src_txt.place(x=100, y=100, height=30, width=300)
...
lab_dest_txt = Label(root, text="Dest Text", font=("Times New Roman", 20, "bold"), fg="black", bg="red")
